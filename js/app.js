!(function (e) {
    ...
    function (e, t, n) {
        ...
        !(function (t, n) {
            ...
            var C = (function (e) {
                ...
                (ae.attr = function (e, t) {
                    ...
                    var o = i.attrHandle[t.toLowerCase()],
                        r = o && H.call(i.attrHandle, t.toLowerCase()) ? o(e, t, !g) : void 0;
                                    ...
                                    var n = t.length > 0,
                                        ...
                                        r = function (r, s, a, l, d) {
                                            ...
                                            if (((y += m), n && m !== y)) {
                                                ...
                                                if (r) {
                                                    if (y > 0) for (; m--; ) w[m] || b[m] || (b[m] = j.call(l));
                                                    b = Te(b);
                                                }
                ...
                k.each(
                    {
                        ...
                        contents: function (e) {
                            return null != e.contentDocument && s(e.contentDocument) ? e.contentDocument : (H(e, "template") && (e = e.content || e), k.merge([], e.childNodes));
                        },
                    },
                    function (e, t) {
                        k.fn[e] = function (n, i) {
                            var o = k.map(this, t, n);
                            return "Until" !== e.slice(-5) && (i = n), i && "string" == typeof i && (o = k.filter(i, o)), this.length > 1 && (P[e] || k.uniqueSort(o), N.test(e) && o.reverse()), this.pushStack(o);
                        };
                    }
                );
            var M = /[^\x20\t\r\n\f]+/g;
                        ...
                        var t = [
                            ...
                            o = {
                                ...
                                then: function (e, i, o) {
                                                        ...
                                                        (c = n && ("object" == typeof n || "function" == typeof n) && n.then),
                                                            y(c)
                                                                ? o
                                                                    ...
                                                                    : (r++, c.call(n, s(r, t, I, o), s(r, t, z, o), s(r, t, I, t.notifyWith)))
                                                ...
                                                d = o
                                                    ...
                                                    : function () {
                                                          try {
                                                              ...
                                                              k.Deferred.exceptionHook && k.Deferred.exceptionHook(n, d.stackTrace), e + 1 >= r && (i !== z && ((a = void 0), (l = [n])), t.rejectWith(a, l));
                                                          }
                                                      };
                                    ...
                                    return k
                                        .Deferred(function (n) {
                                            t[0][3].add(s(0, n, y(o) ? o : I, n.notifyWith)), t[1][3].add(s(0, n, y(e) ? e : I)), t[2][3].add(s(0, n, y(i) ? i : z));
                                        })
                                        .promise();
                                },
                                promise: function (e) {
            ...
            (k.fn.ready = function (e) {
                ...
                (k.ready.then = F.then),
                "complete" === w.readyState || ("loading" !== w.readyState && !w.documentElement.doScroll) ? n.setTimeout(k.ready) : (w.addEventListener("DOMContentLoaded", B), n.addEventListener("load", B));
                ...
                for (var r, s, a, l, c, d, u = t.createDocumentFragment(), p = [], f = 0, h = e.length; f < h; f++)
                    if ((r = e[f]) || 0 === r)
                        if ("object" === T(r)) k.merge(p, r.nodeType ? [r] : r);
                            ...
                            for (s = s || u.appendChild(t.createElement("div")), a = (ve.exec(r) || ["", ""])[1].toLowerCase(), l = me[a] || me._default, s.innerHTML = l[1] + k.htmlPrefilter(r) + l[2], d = l[0]; d--; ) s = s.lastChild;
                            k.merge(p, s.childNodes), ((s = u.firstChild).textContent = "");
                        } else p.push(t.createTextNode(r));
                for (u.textContent = "", f = 0; (r = p[f++]); )
                    if (i && k.inArray(r, i) > -1) o && o.push(r);
                    else if (((c = se(r)), (s = we(u.appendChild(r), "script")), c && be(s), n)) for (d = 0; (r = s[d++]); ) ye.test(r.type || "") && n.push(r);
                return u;
            }
            var ke = /^key/,
            ...
            function He(e, t, n, i, o, r) {
                var s, a;
                if ("object" == typeof t) {
                    for (a in ("string" != typeof n && ((i = i || n), (n = void 0)), t)) He(e, a, n, i, t[a], r);
                    return e;
                }
                    ...
                    ? (J.set(e, t, !1),
                      k.event.add(e, t, {
                          ...
                          handler: function (e) {
                              ...
                              } else r.length && (J.set(this, t, { value: k.event.trigger(k.extend(r[0], k.Event.prototype), r.slice(1), this) }), e.stopImmediatePropagation());
                          },
                      }))
            ...
            (k.event = {
                ...
                special: {
                    ...
                    click: {
                        setup: function (e) {
                            var t = this || e;
                            return ge.test(t.type) && t.click && H(t, "input") && De(t, "click", $e), !1;
                        },
                        trigger: function (e) {
                            var t = this || e;
                            return ge.test(t.type) && t.click && H(t, "input") && De(t, "click"), !0;
                        },
                        _default: function (e) {
                            var t = e.target;
                            return (ge.test(t.type) && t.click && H(t, "input") && J.get(t, "click")) || H(t, "a");
                        },
                    },
                    beforeunload: {
            ...
            function Me(e, t) {
                var n, i, o, r, s, a;
                if (1 === t.nodeType) {
                    if (J.hasData(e) && (a = J.get(e).events)) for (o in (J.remove(t, "handle events"), a)) for (n = 0, i = a[o].length; n < i; n++) k.event.add(t, o, a[o][n]);
                        ...
                        for (d = s[s.length - 1].ownerDocument, k.map(s, qe), u = 0; u < a; u++)
                            (c = s[u]),
                                ye.test(c.type || "") &&
                                    ...
                                    k.contains(d, c) &&
                                    (c.src && "module" !== (c.type || "").toLowerCase() ? k._evalUrl && !c.noModule && k._evalUrl(c.src, { nonce: c.nonce || c.getAttribute("nonce") }, d) : x(c.textContent.replace(Le, ""), c, d));
                }
                return e;
            }
            function We(e, t, n) {
            ...
            k.extend({
                ...
                clone: function (e, t, n) {
                    ...
                    if (t)
                        if (n) for (r = r || we(e), s = s || we(a), i = 0, o = r.length; i < o; i++) Me(r[i], s[i]);
                        else Me(e, a);
            ...
            function _e(e, t, n) {
                ...
                return (
                    (n = n || Fe(e)) &&
                        ...
                        !v.pixelBoxStyles() && Re.test(s) && Ue.test(t) && ((i = a.width), (o = a.minWidth), (r = a.maxWidth), (a.minWidth = a.maxWidth = a.width = s), (s = n.width), (a.width = i), (a.minWidth = o), (a.maxWidth = r))),
                    void 0 !== s ? s + "" : s
                );
            }
            function Xe(e, t) {
            ...
            function it(e, t, n) {
                ...
                return (
                    ((!v.boxSizingReliable() && o) || (!v.reliableTrDimensions() && H(e, "tr")) || "auto" === s || (!parseFloat(s) && "inline" === k.css(e, "display", !1, i))) &&
            ...
            k.extend({
                ...
                k.each(["height", "width"], function (e, t) {
                    k.cssHooks[t] = {
                        get: function (e, n, i) {
                            if (n)
                                return !Je.test(k.css(e, "display")) || (e.getClientRects().length && e.getBoundingClientRect().width)
                                    ? it(e, t, i)
                                    : Be(e, Ze, function () {
                                          return it(e, t, i);
                                      });
            ...
            function ft(e, t, n) {
                ...
                for (
                    ...
                    if ((i = ft.prefilters[r].call(c, e, d, c.opts))) return y(i.stop) && (k._queueHooks(c.elem, c.opts.queue).stop = i.stop.bind(i)), i;
                return (
                    k.map(d, pt, c),
                        ...
                        if ((l = !k.isEmptyObject(t)) || !k.isEmptyObject(f))
                            ...
                            f))
                                l ||
                                    ...
                                    g && pe([e], !0),
                                    p.done(function () {
                                        for (i in (g || pe([e]), J.remove(e, "fxshow"), f)) k.style(e, i, f[i]);
                                    })),
                                    (l = pt(g ? v[i] : 0, i, p)),
                ...
                k.fn.extend({
                    ...
                    hasClass: function (e) {
                        var t,
                            n,
                            i = 0;
                        for (t = " " + e + " "; (n = this[i++]); ) if (1 === n.nodeType && (" " + mt(wt(n)) + " ").indexOf(t) > -1) return !0;
                        return !1;
                    },
                });
            var xt = /\r/g;
                        ...
                        select: {
                            get: function (e) {
                                ...
                                for (i = r < 0 ? l : s ? r : 0; i < l; i++)
                                    if (((n = o[i]).selected || i === r) && !n.disabled && (!n.parentNode.disabled || !H(n.parentNode, "optgroup"))) {
                ...
                k.fn.extend({
                    ...
                    serializeArray: function () {
                        return this.map(function () {
                            ...
                            .filter(function () {
                                var e = this.type;
                                return this.name && !k(this).is(":disabled") && Dt.test(this.nodeName) && !Ht.test(e) && (this.checked || !ge.test(e));
                            })
                            .map(function (e, t) {
                                var n = k(this).val();
                                return null == n
            ...
            (Rt.href = St.href),
                    ...
                    ajax: function (e, t) {
                        ...
                        f.hasContent
                            ...
                            : ((p = f.url.slice(o.length)),
                              ...
                              !1 === f.cache && ((o = o.replace(Nt, "$1")), (p = ($t.test(o) ? "&" : "?") + "_=" + Ct.guid++ + p)),
                              (f.url = o + p)),
                        ...
                        function C(e, t, s, l) {
                            ...
                            c ||
                                ...
                                (S.status = e),
                                (S.statusText = (t || T) + ""),
                                u ? v.resolveWith(h, [p, T, S]) : v.rejectWith(h, [S, T, w]),
                                S.statusCode(m),
                                (m = void 0),
                                d && g.trigger(u ? "ajaxSuccess" : "ajaxError", [S, f, u ? p : w]),
                                y.fireWith(h, [S, T]),
                                d && (g.trigger("ajaxComplete", [S, f]), --k.active || k.event.trigger("ajaxStop")));
                        }
                        return S;
                    },
                ...
                k.each(["get", "post"], function (e, t) {
                    k[t] = function (e, n, i, o) {
                        return y(n) && ((o = o || i), (i = n), (n = void 0)), k.ajax(k.extend({ url: e, type: t, dataType: o, data: n, success: i }, k.isPlainObject(e) && e));
                    };
                }),
            ...
            k.ajaxSetup({
                ...
                k.ajaxPrefilter("json jsonp", function (e, t, i) {
                    ...
                    if (a || "jsonp" === e.dataTypes[0])
                        return (
                            ...
                            i.always(function () {
                                void 0 === r ? k(n).removeProp(o) : (n[o] = r), e[o] && ((e.jsonpCallback = t.jsonpCallback), Vt.push(o)), s && y(r) && r(s[0]), (s = r = void 0);
                            }),
                            "script"
                        );
                }),
                ...
                (k.parseHTML = function (e, t, n) {
                    return "string" != typeof e
                        ...
                        : ("boolean" == typeof t && ((n = t), (t = !1)),
                          ...
                          (r = !n && []),
                          (o = D.exec(e)) ? [t.createElement(o[1])] : ((o = Te([e], t, r)), r && r.length && k(r).remove(), k.merge([], o.childNodes)));
                    var i, o, r;
                }),
                ...
                k.each(["top", "left"], function (e, t) {
                    k.cssHooks[t] = Xe(v.pixelPosition, function (e, n) {
                        if (n) return (n = _e(e, t)), Re.test(n) ? k(e).position()[t] + "px" : n;
                    });
                }),
    ...
    function (e, t, n) {
        n(2), n(11), n(16), (e.exports = n(18));
    },
    function (e, t, n) {
        (window.$ = n(0)), (window.slick = n(3)), n(4);
    },
    function (e, t, n) {
        var i, o, r;
        !(function (s) {
    ...
    function (e, t) {
        var n = sessionStorage.getItem("firstTime");
        function i(e) {
            var t = location.hash;
            "" !== (t = location.hash.substr(1)) && $("#" + t).length
                ? $("html, body")
                      .stop()
                      .animate({ scrollTop: $("#" + t).offset().top - $("header").innerHeight() - 20 }, 1e3)
                : $(window).scrollTop(e);
        }
        function o() {
            $(window).width() > 768 ? $(".learning-model-wrap.slider").slick("unslick") : r();
        }
        function r() {
            $(".learning-model-wrap.slider").slick({ arrows: !1, slidesToShow: 2, slidesToScroll: 1, dots: !0, responsive: [{ breakpoint: 500, settings: { slidesToShow: 1 } }] });
        }
        $(document).ready(function () {
            console.log("ready"),
                ...
                n &&
                    ...
                    setTimeout(function () {
                        $(".brain, .chat, .planet, .sand-dial").addClass("animate");
                    }, 5e3),
                    i(1)),
                $(".faqs--scrolling-accordion h3").click(function () {
                    $(".faqs--scrolling-accordion p").not($(this).next()).slideUp(500),
                        $(this).next().slideToggle(500),
                        $(".faqs--scrolling-accordion").not($(this).closest(".faqs--scrolling-accordion")).removeClass("active"),
                        $(this).closest(".faqs--scrolling-accordion").toggleClass("active");
                }),
                $(".faqs--scrolling-content>div:nth-child(1) .faqs--scrolling-accordion:first-of-type h3").click(),
                $(".header--placeholder").css({ height: $("header").innerHeight() }),
                $("#app").css({ minHeight: $(window).height() - $("header").innerHeight() - $("footer").innerHeight() }),
                $(".single-page").css({ minHeight: $(window).height() - $("header").innerHeight() }),
                $(".coming-soon").css({ minHeight: $(window).height() }),
                $("[tr-delay]").each(function () {
                    var e = $(this).attr("tr-delay");
                    $(this).css("transition-delay", e);
                });
            var e = 0;
            $(window).scroll(function () {
                var t = $(window).scrollTop();
                $(".section--curriculum .left").length
                    ? t > $(".section--curriculum .left").offset().top + $("header").height()
                    ...
                    $("[anim-target]").each(function () {
                        t > e && $(this).offset().top < $(window).scrollTop() + $(window).height() - 100 && $(this).addClass("show");
                    }),
                    (e = t);
            }),
                $("input.name").on("keypress keyup", function (e) {
                    var t = e.which;
                    (t >= 65 && t <= 122) || 32 == t || 0 == t || e.preventDefault();
                    var n = $(this).val();
                    $(this).val(n.replace(/[^a-zA-Z ]/g, ""));
                }),
                $("input[type='tel']").on("keypress keyup", function (e) {
                    var t = e.which;
                    t > 31 && (t < 48 || t > 57) && e.preventDefault();
                    var n = $(this).val();
                    $(this).val(n.replace(/[^0-9]/g, ""));
                }),
                $(window).width() > 768 &&
                    ($(".sticky-inner").css({ minHeight: $(window).height() - $("header").innerHeight() - 50 }),
                    $(".pwheight").each(function (e) {
                        0 ? $(this).css({ minHeight: $(window).height() - $(this).prev().outerHeight(!0) - $("header").innerHeight() }) : $(this).css({ minHeight: $(window).height() - $("header").innerHeight() });
                    })),
                $(window).width() <= 768 && ($(".floating-enroll").length && $("footer").css({ "margin-bottom": $(".floating-enroll").innerHeight() }), r()),
                window.matchMedia("(max-width: 768px)").matches && $(".faqs--fixed-menu ul").css({ top: $("header").innerHeight() }),
                $(".faqs--fixed-menu li a")
                    .not(".not-tab")
                    .click(function (e) {
                        e.preventDefault();
                        var t = $(this);
                        $(".faqs--fixed-menu li a").removeClass("active"),
                            t.addClass("active"),
                            $(window).width() <= 768 &&
                                $(".faqs--fixed-menu ul")
                                    .stop()
                                    .animate({ scrollLeft: $(".faqs--fixed-menu li a.active").offset().left - 50 });
                    }),
                (function () {
                    var e = $("[sticky-element]");
                    if (e.length) {
                        var t,
                            n = e.parent(),
                            i = $("header").height(),
                        ...
                        $(window).width() >= 1024 &&
                            $(window).on("scroll", function () {
                                n.css({ "min-height": e.innerHeight(), height: "100%" }), (e = $("[sticky-element]"));
                                var s = $(window).height(),
                                    a = e.innerHeight(),
                                    l = n.offset().top + n.height() - s,
                                    c = n.offset().top + a - s,
                                    d = n.offset().top - i,
                                    u = $(window).scrollTop(),
                                    p = e.offset().top - n.offset().top;
                                u > o
                                    ? ((t = e.offset().top),
                                      a >= s - i &&
                                          (u > c && !e.hasClass("stickyOff") && (r("fixed", s - a, n.offset().left, "unset"), e.addClass("stickyOn").removeClass("topStopped")),
                                          e.hasClass("stickyOff") && !e.hasClass("bottomStopped") && (r("relative", p, 0, "unset"), u > e.offset().top + a - s && e.removeClass("stickyOff")),
                                          u > l && (r("relative", n.height() - e.height(), 0, "unset"), e.addClass("stickyOff bottomStopped").removeClass("stickyOn"))),
                                      a <= s - i &&
                                          (u > e.offset().top + 0 - i && !e.hasClass("bottomStopped") && r("fixed", i + 10, n.offset().left, "unset"),
                                          u > n.height() + n.offset().top - a - i - 10 && (r("relative", n.height() - e.height(), 0, "unset"), e.addClass("bottomStopped").removeClass("topStopped"))),
                                      u + s > e.offset().top + e.height() && e.removeClass("bottomStopped"))
                                    : (a >= s - i &&
                                          (e.hasClass("stickyOn") && !e.hasClass("topStopped") && (r("relative", p, 0, "unset"), e.removeClass("stickyOn").addClass("stickyOff"), (t = e.offset().top)),
                                          u < t - i && !e.hasClass("topStopped") && (r("fixed", i + 10, n.offset().left, "unset"), e.removeClass("bottomStopped")),
                                          u < d && (r("relative", 0, 0, "auto"), e.addClass("stickyOn topStopped").removeClass("stickyOff"))),
                                      a <= s - i &&
                                          (u < e.offset().top + 0 - i && !e.hasClass("topStopped") && r("fixed", i + 10, n.offset().left, "unset"),
                                          u < d && (r("relative", 0, 0, "auto"), e.addClass("topStopped").removeClass("bottomStopped")))),
                                    (o = u);
                            });
                    }
                    function r(e, t, i, o) {
                        $("[sticky-element]").css({ position: e, width: n.width(), top: t, left: i, bottom: o });
                    }
                })(),
                $("[data-href]").on("click", function (e) {
                    e.preventDefault();
                    var t = parseInt($(this).attr("data-href-top"));
                    (t = "#enroll-now" == $(this).attr("data-href") ? t : t - $("header").innerHeight() - 20), $("html, body").stop().animate({ scrollTop: t }, 600);
                }),
                $(".faqs--fixed-menu a")
                    .not(".not-tab")
                    .on("click", function (e) {
                        if ((e.preventDefault(), "" !== this.hash)) {
                            var t = this.hash;
                            $("html, body").animate({ scrollTop: $(t).offset().top - $("header").innerHeight() - 20 }, 800);
                        }
                    }),
                $(window).on("scroll", function () {
                    var e = $(window).scrollTop(),
                        ...
                        n = $(".parallax-overlap"),
                        i = $(window).height();
                    if ($(".parallax-overlap").length) {
                        var o = n.offset().top - $("header").innerHeight();
                        e > n.offset().top - i
                            ? (t.css({ position: "fixed", bottom: 0, zIndex: 50 }).addClass("fixed"), n.css({ position: "relative", marginTop: o, zIndex: 52 }))
                            : (t.removeAttr("style").removeClass("fixed"), n.removeAttr("style")),
                            e > n.offset().top - i ? $(".floating-enroll").addClass("hide") : $(".floating-enroll").removeClass("hide"),
                            $(window).width() > 768 ? (e > 100 ? $(".scroll-down").stop().fadeOut(200) : $(".scroll-down").stop().fadeIn(200)) : $(".scroll-down").stop().fadeOut(200),
                            $(window).width() <= 768 && $(".fixed-hamburder-menu").css({ height: i - $("header").innerHeight() });
                    }
                }),
                $(".fixed-hamburder-menu ul li a").on("click", function () {
            ...
            $(window).on("load", function () {
                setInterval(function () {
                    $("body").hasClass("loaded") ||
                        ...
                        $("body").hasClass("loaded") &&
                            ($("body").hasClass("home") && !n
                                ? (setTimeout(function () {
                                      $("header .navigation").removeClass("hidden"), $(".preloader").addClass("hide"), $("body").removeClass("fixed"), i(1), setCookie("hasVisited", !0, 7);
                                  }, 3e3),
                                  setTimeout(function () {
                                      $(".brain, .chat, .planet, .sand-dial").addClass("animate");
                                  }, 5500))
                                : ($("header .navigation").removeClass("hidden"), $(".preloader").addClass("hide"), $("body").removeClass("fixed"), i(1)),
                            (foH = $("#verify-otp").height()),
                            $("#verify-otp>.form-part-2").hide(),
                            (frH = $(".form-container").innerHeight() - $("#register").height()),
                            $(".form-container")
                                .not(".contact")
                                .css({ height: $("#register").height() + frH }),
                            $("[data-href]").each(function () {
                                var e = $(this).attr("data-href");
                                $(e).length && $(this).attr("data-href-top", $(e).offset().top);
                            }),
                            $("[data-path]").each(function () {
                                var e = parseInt($(this).attr("data-path"), 10),
                                    t = 0;
                                for (t = 1; t < e + 1; t++) $(this).append('<span class="path' + t + '"></span>');
                            })));
                }, 500),
                    $("[minlength]").on("keyup keypress change", function () {
                        var e = parseInt($(this).attr("minlength")),
                            t = "Enter OTP" == $(this).attr("placeholder") ? "OTP" : "mobile number";
                        $(this).val().length < e
                            ? $(this)
                                  .next(".error")
                                  .text("Kindly enter " + e + " digits " + t)
